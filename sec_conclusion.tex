...
\gbt{Future research should experiment with other datasets (reddits from other domains, other online communities) and also alternative models that address the challenges described here.}
