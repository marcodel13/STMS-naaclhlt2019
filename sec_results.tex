...
$p<0.001$). In particular, we find that the model captures well shifts related to metonymy and memes. This can be observed in Figure \ref{fig:shift-cosine}, where the examples mentioned throughout the paper are pointed out.
