...
Finally, memes---where fans use a word to make jokes and be sarcastic---are another prominent source of meaning shift. For instance, as the club was about to sign a new player named Van Dijk, redditors exploited the homography of the surname with the common noun {\em `van'} and the shoe brand `Vans': `\textit{Rumour has it Van Djik was wearing these vans in the van}'. Jokes of this kind are positively received by the community (`\textit{Hahah I love it. Anything with vans is instant karma!}') and quickly become frequent in it.
