...
allows for a more systematic evaluation and analysis and enables
comparison in future studies.\gbt{to do: Remove redundancy with the intro. I put this
  in the intro cause I think we need to make it more prominent}
