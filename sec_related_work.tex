...
Note, however, that distributional representations from different time periods cannot be directly compared. 
...
according to the model~\cite{hamilton2016diachronic,del2016tracing,kim2014temporal}.
