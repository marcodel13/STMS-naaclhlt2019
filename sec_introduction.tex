...
from the online agreement on words meaning in dyadic interactions \cite{brennan1996conceptual} to the rapid spread of new meanings in relatively small communities of people \cite{del2017semantic,del2018road}\marco{added ref to coling}. In this paper we focus on this latter  phenomenon, that we call \textit{short-term meaning shift}.
