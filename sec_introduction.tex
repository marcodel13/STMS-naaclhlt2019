...
from the online agreement on words meaning in dyadic interactions \cite{brennan1996conceptual} to the rapid spread of new meanings in relatively small communities of people \cite{wenger1998communities,eckert-mcconnellginet1992}.\todo{M: substituted our cit. with more linguistic thing, so to be more consistent with what we say next} 
